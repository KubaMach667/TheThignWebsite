...
export default function Inspirations({language}) {
  return (
    <div>
        ...
        I percieved not only art but also politics and philosophy. - kuba
      ...
      Pierwsze cztery rzędy (szczególnie top 10) to monolity tak wielkie, że nawet nie potrafię sobie nawet wyobrazić 
       wejścia na taki poziom artystyczny. Większość albumów na tej liście zmieniło nie tylko to jak odbieram sztukę, ale również politykę oraz filozofię. - kuba
